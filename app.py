...
def generate_fallback_exam_paper(subject, university, exam_type, branch):
    ...
    Includes subject detection for Operating Systems, DBMS, Data Structures, Computer Networks, Compiler Design, Physics, Software Eng, Math, or Dynamic Subject Matching.
    """
    ...
    if "operat" in sub_lower or "os" in sub_lower:
    ...
    elif "netw" in sub_lower or "cn" in sub_lower:
        ...
        # Dynamic Subject Generator for Any Custom Subject (e.g. Python, SE, Math, Robotics, Cyber Security, etc.)
        part_a_qs = [
