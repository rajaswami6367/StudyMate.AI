...
def generate_fallback_exam_paper(subject, university, exam_type, branch):
    ...
    elif "math" in sub_lower or "mathematic" in sub_lower or "m1" in sub_words or "m2" in sub_words or "m3" in sub_words or "discrete" in sub_lower:
        part_a_qs = [
            ...
            {"unit": "Unit I: Eigenvectors", "pyq_source": "RTU Kota 2017, 2019, 2021, 2023 (Repeated 4x)", "question": "Define Eigenvalues and Eigenvectors of a matrix. State property of sum and product of eigenvalues.", "model_answer": "Sum of eigenvalues equals Trace(A) (sum of main diagonal elements). Product of eigenvalues equals determinant |A|.", "marking_scheme": "1.5 marks for definition, 1.5 marks for Trace and Determinant properties."},
            {"unit": "Unit II: Differential Calculus", "pyq_source": "RTU Kota 2019, 2021, 2022", "question": "State Rolle's Theorem and Lagrange's Mean Value Theorem for a continuous function f(x).", "model_answer": "Rolle's: f(a)=f(b) implies f'(c)=0. LMVT: f'(c) = (f(b) - f(a)) / (b - a) for c in (a,b).", "marking_scheme": "1.5 marks for Rolle's, 1.5 marks for LMVT."},
            {"unit": "Unit II: Maclaurin Series", "pyq_source": "RTU Kota 2018, 2020, 2023", "question": "Expand f(x) = e^x * sin(x) using Maclaurin's Series up to x^3 term.", "model_answer": "f(0)=0, f'(0)=1, f''(0)=2, f'''(0)=2. Expansion: f(x) = x + x^2 + (x^3 / 3) + ...", "marking_scheme": "1.5 marks for derivatives, 1.5 marks for series expansion."},
            ...
            {"unit": "Unit III: Partial Differentiation", "pyq_source": "RTU Kota 2018, 2021, 2023", "question": "If u = log((x^4 + y^4)/(x + y)), evaluate x*(du/dx) + y*(du/dy) using Euler's Theorem.", "model_answer": "Let e^u = (x^4 + y^4)/(x + y) (degree 3). Then x*(du/dx) + y*(du/dy) = 3.", "marking_scheme": "1.5 marks for degree calculation, 1.5 marks for final value 3."},
            {"unit": "Unit IV: Beta & Gamma Functions", "pyq_source": "RTU Kota 2019, 2020, 2022", "question": "State relation between Beta function B(m,n) and Gamma function Gamma(n). State value of Gamma(1/2).", "model_answer": "B(m,n) = (Gamma(m) * Gamma(n)) / Gamma(m+n). Gamma(1/2) = sqrt(pi).", "marking_scheme": "1.5 marks for Beta-Gamma relation, 1.5 marks for Gamma(1/2) = sqrt(pi)."},
            {"unit": "Unit IV: Double Integrals", "pyq_source": "RTU Kota 2017, 2020, 2023", "question": "Change the order of integration for integral I = Integral(0 to 1) Integral(x to 1) f(x,y) dy dx.", "model_answer": "Reverses region limits: I = Integral(0 to 1) Integral(0 to y) f(x,y) dx dy.", "marking_scheme": "1.5 marks for region diagram, 1.5 marks for reversed integral."},
            {"unit": "Unit V: Differential Equations", "pyq_source": "RTU Kota 2018, 2021", "question": "Find Particular Integral (PI) for differential equation (D^2 + 4)y = sin(2x).", "model_answer": "PI = x * (-cos(2x) / (2*2)) = -x * cos(2x) / 4.", "marking_scheme": "3 marks for Particular Integral PI formula."},
            {"unit": "Unit V: Laplace Transforms", "pyq_source": "RTU Kota 2019, 2022", "question": "Find Laplace Transform of f(t) = t^2 * e^(3t) * cos(4t).", "model_answer": "Uses s-shifting property L{e^(at)*f(t)} = F(s-a) and frequency differentiation -d/ds.", "marking_scheme": "1.5 marks for s-shift, 1.5 marks for differentiation rule."}
        ]
        part_b_qs = [
            {"unit": "Unit I: Cayley-Hamilton Verification", "pyq_source": "RTU Kota 2018, 2020, 2022, 2023 (Repeated 4x)", "question": "Verify Cayley-Hamilton Theorem for Matrix A = [[1, 2], [3, 4]] and hence calculate Inverse Matrix A^-1 and A^4.", "model_answer": "Characteristic eq: lambda^2 - 5*lambda - 2 = 0. Verifies A^2 - 5A - 2I = 0. Computes A^-1 = 1/2 * [[-4, 2], [3, -1]].", "marking_scheme": "3 marks for Cayley-Hamilton proof, 3 marks for A^-1 calculation."},
            {"unit": "Unit III: Lagrange Multipliers Maxima Minima", "pyq_source": "RTU Kota 2017, 2019, 2021, 2023 (Repeated 4x)", "question": "Find the maximum and minimum values of f(x, y, z) = x^2 + y^2 + z^2 subject to constraint x + y + z = 12 using Lagrange Multipliers method.", "model_answer": "Sets grad(f) = lambda * grad(g). Finds stationary point x = y = z = 4. Minimum value = 48.", "marking_scheme": "3 marks for Lagrange equations, 3 marks for stationary point and min value."},
            {"unit": "Unit V: Variation of Parameters ODE", "pyq_source": "RTU Kota 2019, 2021, 2022", "question": "Solve differential equation (D^2 + 1)y = sec(x) using Method of Variation of Parameters.", "model_answer": "CF = c1*cos(x) + c2*sin(x). PI = u*cos(x) + v*sin(x). Computes Wronskian W=1. PI = x*sin(x) + cos(x)*log(cos(x)).", "marking_scheme": "3 marks for Wronskian & PI integrals, 3 marks for general solution."},
            {"unit": "Unit V: Fourier Series Numerical", "pyq_source": "RTU Kota 2018, 2020, 2023", "question": "Find Fourier Series expansion for f(x) = x^2 in the interval (-pi, pi). Hence deduce that 1/1^2 - 1/2^2 + 1/3^2 - 1/4^2 ... = pi^2 / 12.", "model_answer": "a0 = (2*pi^2)/3, an = 4*(-1)^n / n^2, bn = 0. Evaluates series at x=0 to prove pi^2 / 12.", "marking_scheme": "3 marks for Fourier coefficients a0, an, 3 marks for deduction proof."}
        ]
        part_c_qs = [
            {"unit": "Unit I: Eigenvalues & Diagonalization Numerical", "pyq_source": "RTU Kota 2018, 2020, 2022, 2023 (10-Mark Mandatory)", "question": "Find Eigenvalues and Eigenvectors of 3x3 Matrix A = [[2, 1, 1], [1, 2, 1], [0, 0, 1]]. Construct Diagonalizing Matrix P such that P^-1 * A * P = D.", "model_answer": "Eigenvalues lambda = 1, 1, 3. Computes 3 linearly independent eigenvectors. Verifies diagonal matrix D = diag(1, 1, 3).", "marking_scheme": "3.5 marks for Eigenvalues & Eigenvectors, 4.5 marks for Matrix P construction, 2.5 marks for P^-1 AP = D proof."},
            {"unit": "Unit IV: Polar Double Integral & Area", "pyq_source": "RTU Kota 2017, 2019, 2021, 2023 (10-Mark Mandatory)", "question": "Evaluate Double Integral SS (x^2 + y^2) dx dy over the region in the first quadrant bounded by circles x^2 + y^2 = 4 and x^2 + y^2 = 16 by transforming into Polar Coordinates (r, theta).", "model_answer": "Transforms to polar: r from 2 to 4, theta from 0 to pi/2. Integrates Integral(0 to pi/2) Integral(2 to 4) r^3 dr dtheta = 60 * pi.", "marking_scheme": "3.5 marks for polar transformation & limits, 4.5 marks for r and theta integrals, 2.5 marks for final 60*pi value."},
            {"unit": "Unit V: PDE & Method of Separation of Variables", "pyq_source": "RTU Kota 2019, 2021, 2022, 2023", "question": "Solve 1D Heat Conduction Equation (du/dt) = c^2 * (d^2 u / dx^2) for a rod of length L with boundary conditions u(0,t)=0, u(L,t)=0 and initial condition u(x,0) = sin(3*pi*x / L) using Method of Separation of Variables.", "model_answer": "Assumes u(x,t) = X(x)*T(t). Solves spatial X(x) and temporal T(t). Solution: u(x,t) = sin(3*pi*x / L) * e^(-9*pi^2*c^2*t / L^2).", "marking_scheme": "3.5 marks for separation of variables, 4.5 marks for boundary condition matching, 2.5 marks for final solution."}
        ]
